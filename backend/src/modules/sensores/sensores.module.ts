...
@Module({
  ...
  imports: [
    TypeOrmModule.forFeature([Sensor, Sublote, Broker, BrokerLote, Cultivo, InformacionSensor, Produccion, Venta, Gasto, Actividad, ActividadMaterial, Material, Usuario, TipoUsuario]),
