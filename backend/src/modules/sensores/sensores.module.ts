...
@Module({
  ...
  imports: [
    ...
    TypeOrmModule.forFeature([Sensor, Sublote, Lote, Broker, BrokerLote, Cultivo, InformacionSensor, Produccion, Venta, Gasto, Actividad, ActividadMaterial, Material, Usuario, TipoUsuario]),
