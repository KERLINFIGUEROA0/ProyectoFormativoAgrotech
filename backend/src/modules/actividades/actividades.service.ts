...
export class ActividadesService {
  ...
  async findOne(id: number) {
    return this.actividadRepository.findOne({
      where: { id },
      relations: ['usuario', 'usuario.ficha', 'cultivo', 'actividadMaterial', 'actividadMaterial.material'],
    });
  }
  ...
  async devolverMaterialesFinal(id: number, dto: DevolverMaterialesFinalDto, userIdentificacion: number) {
    ...
    if (actividad.estado !== 'completado') throw new BadRequestException('La actividad debe estar completada.');
