...
import { Plus, Search, Bell, Edit, Trash2, ChevronLeft, ChevronRight } from 'lucide-react';
...
export default function GestionInventarioPage() {
  ...
  // ✅ 1. AÑADIMOS ESTADOS PARA CADA FILTRO
  ...
  // ✅ 3. OBTENEMOS LAS OPCIONES ÚNICAS PARA LOS SELECTS
  ...
  return (
    <div className="p-2 sm:p-6 bg-gray-50 min-h-full font-sans">
      ...
      {/* --- ✅ 5. LA TABLA AHORA USA LOS DATOS FILTRADOS --- */}
                  ...
                  <tr key={mat.id} className={`hover:bg-gray-50 ${!mat.estado ? 'bg-gray-100 text-gray-400' : ''}`}>
                    <td className="px-6 py-4 flex items-center gap-3">
                      <img
                        ...
                        alt={mat.nombre}
                      />
                      <div onClick={() => navigate(`/stock/${mat.id}`)} className="cursor-pointer">
                    ...
                    <td className="px-6 py-4">{mat.cantidad} {mat.tipoMedida}</td>
