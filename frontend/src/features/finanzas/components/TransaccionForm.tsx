  ...
  return (
    <div className="p-4">
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold text-gray-800">Agregar Nueva Venta</h2>
        <p className="text-gray-500">Ingresa la información de la venta realizada</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <FormInput 
          ...
          placeholder="ID de la cosecha vendida"
        />
      </div>
