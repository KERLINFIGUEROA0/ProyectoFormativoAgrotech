...
          // Ya no pasamos nada de íconos aquí, la modificación global se encarga
        },
        draw: {
          polygon: {
...
      // onClose(); // Dejamos que el padre cierre el modal
    }
  };
...
        <div
          ref={mapContainerRef}
          // ID "map" añadido para asegurar que los estilos de leaflet-draw se apliquen
          id="map" 
...
            <li>
              Usa la herramienta de dibujo (polígono) para trazar el área
              deseada (mínimo 3 puntos, máximo 8 puntos)
            </li>
            <li>
...
            </li>
            <li>
              Puedes buscar una ubicación específica usando la barra de búsqueda
            </li>
