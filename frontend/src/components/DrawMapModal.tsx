      ...
      <div className="space-y-4 max-h-[30rem] overflow-y-auto">
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors text-center"
          >
            Confirmar{" "}
          </button>
          {" "}
